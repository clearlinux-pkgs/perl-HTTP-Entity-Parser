...
%prep
%setup -q -n HTTP-Entity-Parser-0.22
cd %{_builddir}/HTTP-Entity-Parser-0.22
...
cp %{_builddir}/HTTP-Entity-Parser-0.22/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Entity-Parser/220fe941787679d8a043c0444548ac186c86f309
if test -f Makefile.PL; then
