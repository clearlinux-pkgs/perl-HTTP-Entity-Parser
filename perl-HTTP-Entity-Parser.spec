...
cd %{_builddir}
tar xf %{_sourcedir}/libhttp-entity-parser-perl_0.21-1.debian.tar.xz
cd %{_builddir}/HTTP-Entity-Parser-0.21
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/HTTP-Entity-Parser-0.21/deblicense/
...
cp %{_builddir}/HTTP-Entity-Parser-0.21/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Entity-Parser/220fe941787679d8a043c0444548ac186c86f309
cp %{_builddir}/HTTP-Entity-Parser-0.21/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-HTTP-Entity-Parser/99e124d09610ef6cc5305ca6ea24e266826e360d
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-HTTP-Entity-Parser/99e124d09610ef6cc5305ca6ea24e266826e360d
