...
Source0  : https://cpan.metacpan.org/authors/id/K/KA/KAZEBURO/HTTP-Entity-Parser-0.23.tar.gz
...
%prep
%setup -q -n HTTP-Entity-Parser-0.23
cd %{_builddir}/HTTP-Entity-Parser-0.23
...
cp %{_builddir}/HTTP-Entity-Parser-0.23/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Entity-Parser/220fe941787679d8a043c0444548ac186c86f309
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/HTTP/Entity/Parser.pm
/usr/lib/perl5/vendor_perl/5.30.3/HTTP/Entity/Parser/JSON.pm
/usr/lib/perl5/vendor_perl/5.30.3/HTTP/Entity/Parser/MultiPart.pm
/usr/lib/perl5/vendor_perl/5.30.3/HTTP/Entity/Parser/OctetStream.pm
/usr/lib/perl5/vendor_perl/5.30.3/HTTP/Entity/Parser/UrlEncoded.pm
